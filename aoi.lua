game.Players.LocalPlayer:Kick("Stop exploiting on UWP, Byfron was added to UWP ROBLOX. Delete UWP ROBLOX and Reinstall, ROBLOX is starting a Ban Wave. Stay safe")
